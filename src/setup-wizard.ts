...
const PROVIDERS: ProviderDef[] = [
    ...
    { id: 'deepseek',     label: 'DeepSeek',                envKey: 'DEEPSEEK_API_KEY',     defaultModel: 'deepseek-v4-flash', keyHelp: 'sk-…', keyUrl: 'https://platform.deepseek.com/api-keys', tier: 2, hermesProvider: 'custom', baseUrl: 'https://api.deepseek.com/v1', testUrl: 'https://api.deepseek.com/models', testAuth: 'bearer' },
